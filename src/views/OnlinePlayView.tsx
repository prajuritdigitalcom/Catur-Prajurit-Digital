      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-4 space-y-3 shadow-xs">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-slate-500 text-[11px]">Dapatkan kode 6-karakter untuk teman Anda.</p>
          </div>
        </div>
      ...
      <div className="bg-white border border-slate-200/90 rounded-3xl p-4 space-y-3 shadow-xs">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            ...
            <p className="text-slate-500 text-[11px]">Masukkan kode 6-karakter dari teman.</p>
          </div>
        </div>
